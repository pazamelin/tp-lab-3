...
std::string DateTime::months[12] =  = { "january", "february", "march", "april", "may", "june", "july", "august", "september", "october", "november", "december" };
std::string DateTime::days[7] = { "sunday", "monday", "tuesday", "wednesday", "thursday", "friday", "saturday" };
int DateTime::daysInMonth[12] = { 31, 28, 31, 30, 31, 30, 31, 31, 30 ,31, 30 ,31 };
